...
```{r, cache.extra = file.info("../models/rundiff-oneseason.stan"), echo = FALSE, comment = NA, collapse = FALSE}
...
```{r fit, cache.extra = file.info("../models/rundiff-oneseason_2011-fit.rds")}
