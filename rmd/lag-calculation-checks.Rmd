...
```{r lag, cache.extra = tools::md5sum("../lag/lag-combined-1990_2016.csv")}
...
```{r lag_ht, cache.extra = tools::md5sum("../lag/lag-combined-1990_2016-ht.csv")}
lag_ht <- read_csv("../lag/lag-combined-1990_2016-ht.csv") %>%
    mutate(date = ymd(date),
           year = year(date),
...
```{r s2_wide, cache.extra = tools::md5sum("../lag/song2017how-table-s2.csv")}
