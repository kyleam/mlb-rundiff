...
selpars <- model_pars[!grepl("^eta", model_pars) &
                      !grepl("scorediff_new", model_pars)]
...
observed <- tibble(scorediff = dat$scorediff[observed_idx],
...
ppc <- trace_intervals(samps$scorediff_new[,observed_idx], "game") %>%
