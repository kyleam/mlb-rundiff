...
```{r fit, cache.extra = file.info("../models/rundiff-split_2011-fit.rds")}
fit <- readRDS("../models/rundiff-split_2011-fit.rds")
```
...
```{r info, cache.extra = file.info("../models/rundiff-split_2011.info.R")}
source("../lib/utils.R")
info <- source_as_list("../models/rundiff-split_2011.info.R")
```
...
```{r dat, cache.extra = file.info("../models/rundiff-split_2011.data.R")}
dat <- source_as_list("../models/rundiff-split_2011.data.R")
```
