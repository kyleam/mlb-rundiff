...
```{r fit, cache.extra = tools::md5sum("../models/rundiff-split_2011-fit.rds")}
...
ggplot(tvals) +
    ...
    scale_color_manual(values = c(tc$primary_light, tc$primary,
                                  tc$secondary_light, tc$secondary))
```
...
```{r info, cache.extra = tools::md5sum("../models/rundiff-split_2011.info.R")}
source("../lib/utils.R")
...
```{r dat, cache.extra = tools::md5sum("../models/rundiff-split_2011.data.R")}
