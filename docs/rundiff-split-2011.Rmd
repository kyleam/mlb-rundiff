...
```{r fit, cache.extra = tools::md5sum("../output/models/rundiff-split_2011-fit.rds")}
fit <- readRDS("../output/models/rundiff-split_2011-fit.rds")
```
...
```{r info, cache.extra = tools::md5sum("../output/models/rundiff-split_2011.info.R")}
source("../code/lib/utils.R")
info <- read_rdump("../output/models/rundiff-split_2011.info.R")
```
...
```{r dat, cache.extra = tools::md5sum("../output/models/rundiff-split_2011.data.R")}
dat <- read_rdump("../output/models/rundiff-split_2011.data.R")
```
